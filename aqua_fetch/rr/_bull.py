...
class Bull(_RainfallRunoff):
    ...
    def dyn_map(self):
        return {
            ...
            # NET (not downward) shortwave, already in W m-2 -- Caravan
            # converts the ERA5-Land J m-2 accumulations for its extensions.
            # min/max are over the hours of the day, so the min is 0 at night.
            'surface_net_solar_radiation_mean_BULL': net_solar_radiation(),
            'surface_net_solar_radiation_max_BULL': max_net_solar_radiation(),
            'surface_net_solar_radiation_min_BULL': min_net_solar_radiation(),
            'surface_net_thermal_radiation_max_BULL': max_net_longwave_radiation(),
            'surface_net_thermal_radiation_mean_BULL': net_longwave_radiation(),
            'surface_net_thermal_radiation_min_BULL': min_net_longwave_radiation(),
